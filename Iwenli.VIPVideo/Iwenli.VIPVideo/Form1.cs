...
namespace Iwenli.VIPVideo
{
    public partial class Form1 : Form
    {
        ...
        private void Inin()
        {
            this.Text = "免费看视频v1.1 PowerBy IWL";
        ...
        private void BingEvent()
        {
            this.serbtn.Click += (sender, e) =>
            {
                ...
                if (flag)
                {
                    MessageBox.Show("网址错误,请重新输入.", "PIG SAY");
                }
                else
                {
                    ...
                    if (flag2)
                    {
                        MessageBox.Show("搜索值不能为空.", "PIG SAY");
                    }
                    else
                    {
        ...
        private void PlayThread()
        {
            ...
            {
                File.WriteAllText(configPath, "error:{0}" + ex.Message);
            }
        ...
        private bool IsPlay()
        {
            ...
            {
                return File.ReadAllText(configPath).IndexOf("{\"errcode\":0,\"errmsg\":\"ok\"}") > -1 ? true : false;
            }
            return false;
        }
    }
